                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single" name="member_id" required  style="width: 100%;">
                                                ...
                                                <option  @if($member->id == $mem->id) selected @endif  value="{{ $mem->id }}">{{ $mem->fname.' '.$mem->lname }} | {{ $mem->member_number }}</option>
                                                @endforeach
                                                </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single" name="member_id" required style="width: 100%;">
                                            @foreach($members as $mem)
                                                <option @if($member->id == $mem->id) selected @endif 
                                                value="{{ $mem->id }}">{{ $mem->fname.' '.$mem->lname }} | {{ $mem->member_number }}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div>
