			...
			<td width="100%" colspan="12" style="max-width: 600px;">
				...
				<tr class="table-head">
					...
					<tr>
						...
						<td width="30" style="border:2px solid #000; padding: 3px 10px; font-weight: 400; vertical-align:middle; text-align:center;padding-top:10px;" valign="middle" align="center"><span class="no-line">{{ $report->wistla_tone_grade }}</span></td>
					...
					<tr>
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Application and ID of Laws</td>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Scurms</td>
					...
					<tr>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Movement Patterns</td>
					...
					<tr class="table-head">
					<th colspan="1" style="border:2px solid #000; padding: 3px 10px;">10m, Markers & Ruck</th>
					...
					<tr>
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">10m Distance</td>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">10m Compliance</td>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Ruck/PTB Speed</td>
					...
					<tr class="table-head">
					<th colspan="1" style="border:2px solid #000; padding: 3px 10px;">Communication and Tackle ID</th>
					...
					<tr>
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Ruck Vocab</td>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Tackle Identification</td>
						...
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">Communication Timing</td>
					...
					<tr>
						<td style="border:2px solid #000; padding: 3px 10px; font-weight: 400;">On the 10m</td>
